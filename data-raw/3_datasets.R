...
usethis::use_data(all_lad_codes_dates, lad_code_changes, database_date, test_codes, test_names, internal = TRUE, overwrite = TRUE)
rm(all_lad_codes_dates, lad_code_changes, database_date, test_codes, test_names)
