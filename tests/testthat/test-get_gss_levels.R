...
test_that("get_geog_levels produces expected output", {
  expect_equal(get_geog_levels(test_data_lad_region), c("lad", "region"))
  expect_equal(get_geog_levels(test_data_lad_region_country), c("lad", "region", "country"))
  expect_equal(get_geog_levels(test_data_lad_country), c("lad", "country"))
})

test_that("get_geog_levels fails when expected", {
  expect_error(get_geog_levels(test_data_error))
})