...
test_that("get_gss_date produces the expected outputs", {
  expect_equal(get_gss_date(test_codes$y2009), 
               list(earliest = as.Date("2009-06-01"), latest = as.Date("2012-03-30")))
  expect_equal(get_gss_date(test_codes$y2012), 
               list(earliest = as.Date("2012-04-01"), latest = as.Date("2013-03-30")))
  expect_equal(get_gss_date(test_codes$y2013), 
               list(earliest = as.Date("2013-04-01"), latest = as.Date("2019-03-30")))
  expect_equal(get_gss_date(test_codes$y2018), 
               list(earliest = as.Date("2013-04-01"), latest = as.Date("2019-03-30"))) # 2018 was only a name change, codes are same as 2013 codes
  expect_equal(get_gss_date(test_codes$y2019), 
               list(earliest = as.Date("2019-04-01"), latest = as.Date("2020-03-30")))
  expect_equal(get_gss_date(test_codes$y2020), 
               list(earliest = as.Date("2020-04-01"), latest = as.Date("2021-03-30")))
  expect_equal(get_gss_date(test_codes$y2021), 
               list(earliest = as.Date("2021-04-01"), latest = as.Date("2023-03-30")))
