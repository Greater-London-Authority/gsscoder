...
usethis::use_data(.sys_all_codes_dates, .sys_code_changes, .sys_database_date, .sys_entity_levels, .sys_lad_region_country,
                  .sys_test_codes, .sys_test_codes_names, .sys_test_codes_parents, internal = TRUE, overwrite = TRUE)
rm(.sys_all_codes_dates, .sys_code_changes, .sys_database_date, .sys_entity_levels, .sys_lad_region_country,
